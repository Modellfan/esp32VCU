...
private:
  ...
  bool jsonTransferInProgress = false; // Tracks if JSON transfer is in progress
  uint32_t jsonTransferPosition = 0;   // Current position in the JSON file
  uint32_t jsonTransferSize = 0;       // Total size of the JSON file
